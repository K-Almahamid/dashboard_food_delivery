...
class AppColors{
  static const Color greyColor = Color(0xFFccc7c5);
  static const Color blueColor = Color(0xFF89dad0);
  //static final Color mainColor = const Color(0xFFfa7552);
  static const Color iconColor1 = Color(0xFFffd28d);
  static const Color mainColor = Color(0xFFfcab88);
  static const Color paraColor = Color(0xFF8f837f);
  static const Color whiteColor= Color(0xFFf7f6f4);
